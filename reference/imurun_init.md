...
imurun_init(dir)
#> Created: /tmp/RtmpaQDzck/imurun_init_18b61198c19f/imurun_template.xlsx
#> Next steps:
#>   1. Open the workbook and fill the observations and locations
#>      sheets (see the instructions sheet).
#>   2. Validate it:  imurun -h /tmp/RtmpaQDzck/imurun_init_18b61198c19f/imurun_template.xlsx
#>   3. Fit it:       imurun /tmp/RtmpaQDzck/imurun_init_18b61198c19f/imurun_template.xlsx
```
